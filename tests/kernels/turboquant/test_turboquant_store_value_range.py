...
Covers the AoS store (``vllm/v1/attention/ops/triton_turboquant_store.py``).
The house SoA sibling under ``turboquant_soa/`` carries the same clamp but a
different cache layout and has no equivalent test yet.
"""
